...
describe("privacyFilter", () => {
  ...
  it("should render Edit document when editable is false", async () => {
    ...
    const { getByText } = render(<PrivacyFilter editable={editable} onToggleEditable={toggleEditable} />);
  ...
  it("should call toggleEditable when toggle button is click", async () => {
    ...
    const { getByTestId } = render(<PrivacyFilter editable={editable} onToggleEditable={toggleEditable} />);
